...
**Demo** [poesiosa.net](https://www.poesiosa.net/) · **Docs** [Architecture](docs/architecture.html) · [Planned](docs/planned.html) · [Baseline](docs/planned-baseline.html) · [Changelog](docs/changelog.html)
